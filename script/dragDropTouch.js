 ...
 * Original file: /npm/drag-drop-touch-polyfill@1.0.0/DragDropTouch.js
 *
  ...
  var i = (function () {
    ...
    return (
          ...
          n &&
            (this._dispatchEvent(e, "mousemove", e.target) ||
              ...
              setTimeout(function () {
                i._dragSource == n &&
                  null == i._img &&
                  i._dispatchEvent(e, "contextmenu", n) &&
                  i._reset();
              }, t._CTXMENU)));
        }
      }),
      ...
      (t.prototype._getTarget = function (t) {
        for (
          var e = this._getPoint(t), i = document.elementFromPoint(e.x, e.y);
          i && "none" == getComputedStyle(i).pointerEvents;
        )
          i = i.parentElement;
        return i;
      }),
      (t.prototype._createImage = function (e) {
        ...
        if (
          ...
          (this._img.style["-webkit-transform"] =
            "translateX(-9999px) translateY(-9999px)"),
          !this._imgCustom)
        ) {
          var n = i.getBoundingClientRect(),
            s = this._getPoint(e);
          ((this._imgOffset = { x: s.x - n.left, y: s.y - n.top }),
      ...
      (t.prototype._moveImage = function (t) {
        ...
        requestAnimationFrame(function () {
          ...
          ((n.position = "fixed"),
            ...
            (n.zIndex = "999999"),
            (n.top = n.left = "0px"));
          var s = Math.round(i.x - e._imgOffset.x),
            o = Math.round(i.y - e._imgOffset.y);
          n["-webkit-transform"] = `translateX(${s}px) translateY(${o}px)`;
        });
      }),
      ...
      (t.prototype._dispatchEvent = function (e, i, n) {
        if (e && n) {
          ...
          return (
            ...
            (s.button = 0),
            (s.which = s.buttons = 1),
            this._copyProps(s, e, t._kbdProps),
            this._copyProps(s, o, t._ptProps),
            (s.dataTransfer = this._dataTransfer),
            n.dispatchEvent(s),
            s.defaultPrevented
          );
        }
      ...
      (t.prototype._closestDraggable = function (t) {
        for (; t; t = t.parentElement)
          if (t.hasAttribute("draggable")) return t;
        return null;
      }),
      (t._instance = new t()),
      (t._THRESHOLD = 5),
...
//# sourceMappingURL=/sm/3be05be0c47e3e8cb37d0efee54314e964c0689f7b9cf6b9a25f6f25418af014.map
